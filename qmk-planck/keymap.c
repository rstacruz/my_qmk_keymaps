...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = { /*
  ...
  */
  ...
  [_NAV] = LAYOUT_planck_2x2u(
    xx_ESC, __v__, KC_TAB, _____, _____, _____, _____,  KC_PGUP,  KC_HOME,  KC_UP,   KC_END,  MO(_FUN),
  ...
  [_FUN] = LAYOUT_planck_2x2u(
    RESET,   KC_F11,  KC_F12, KC_MS_BTN2, KC_MS_BTN1, _____, _____, KC_WH_U, RCTL(LSFT(KC_TAB)), KC_MS_U, RCTL(KC_TAB), KC_MS_BTN2,
    ...
    LAG_SWP, LAG_NRM, __v__,  __v__,      /**/        __v__, __v__, /**/     __v__,              __v__,   __v__,        __v__
  ), /*
  ...
  [_MMM] = LAYOUT_planck_2x2u(
    _____,    _____, _____, _____, _____, _____, _____, MC_HAND, MC_MUTE, _____,  _____,  _____,
    DF(_GAM), _____, _____, _____, _____, _____, _____, MC_SHOT, KC_F13,  KC_F14, KC_F15, KC_F16,
    DF(_LOC), _____, _____, _____, _____, _____, _____, _____,   KC_F17,  KC_F18, KC_F19, KC_F20,
