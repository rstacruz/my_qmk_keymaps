...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = { /*
  ...
  Macros    ┌────┬────┬────┬────┬────┐     ┌────┬────┬────┬────┬────┐
            ...
            │f₁₃ │f₁₄ │f₁₅ │f₁₆ │caps│     │    │    │    │    │    │
  ┌┄┄┄┄┐    ├────┼────┼────┼────┼────┤     ├────┼────┼────┼────┼────┤
  ┆PAD ┆ ┄› │f₁₇ │f₁₈ │f₁₉ │f₂₀ │home│     │    │cmbt│ALT │LOC │GAM │
  └┄┄┄┄┘    └────┴────┴────┴────┴────┘──┬──└────┴────┴────┴────┴────┘
                      │    │ ▓▓ │       │       │ ░░ │    │
                      └────┴────┴───────┴───────┴────┴────┘ */

  [_PAD] = LAYOUT_36(
    MC_MUTE, MC_HAND, MC_SHOT, ___,    ___,         /**/ ___, ___,     ___,      ___,      ___,
    KC_F13,  KC_F14,  KC_F15,  KC_F16, KC_CAPS,     /**/ ___, ___,     ___,      ___,      ___,
    KC_F17,  KC_F18,  KC_F19,  KC_F20, KC_WWW_HOME, /**/ ___, CMB_TOG, TG(_ALT), DF(_LOC), DF(_GAM),
...
const uint16_t PROGMEM combo_2[] = {KC_H, KC_DOT, COMBO_END};

combo_t key_combos[COMBO_COUNT] = {
  [CM_0] = COMBO(combo_0, KC_ENT),
  [CM_1] = COMBO(combo_1, KC_ESC),
  [CM_2] = COMBO(combo_2, x__CBSP),
};
