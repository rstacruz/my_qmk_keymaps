...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_PAD] = LAYOUT_36(
    ...
    DF(_GAM), ___, ___, x__LMB, KC_WH_D, /**/ KC_WH_D, KC_MS_L, KC_MS_D, KC_MS_R, KC_BRID,
    ___,      ___, ___, ___,    x__RMB,  /**/ KC_VOLD, KC_VOLU, KC_MPLY, KC_MNXT, RESET,
    /**/      /**/ _v_, _v_,    _v_,     /**/ _v_,     _v_,     _v_      /**/     /**/
  ),
