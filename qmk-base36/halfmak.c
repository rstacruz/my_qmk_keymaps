...
#else
#error "A LAYOUT_frogfive_18 macro needs to be defined"
#endif

#define FF_BASE_LAYOUT LAYOUT_frogfive_18( \
  LT(FF_NAV,KC_F),  KC_D, KC_N,    KC_I,       KC_G,  \
  LT(FF_FLIP,KC_S), KC_T, KC_H,    KC_E,       KC_O,  \
  LT(FF_SYM,KC_C),  KC_W, KC_R,    KC_A,       KC_U,  \
  /**/              /**/  KC_LCTL, MO(FF_NUM), MT(MOD_LSFT,KC_SPC) )

#define FF_FLIP_LAYOUT LAYOUT_frogfive_18( \
  ___,     KC_J, KC_K,    KC_M,    KC_Q,    \
  ___,     KC_Y, KC_P,    KC_L,    KC_BSPC, \
  KC_LCTL, KC_X, KC_B,    KC_V,    KC_Z,    \
  /**/     /**/  KC_LALT, KC_LGUI, _v_      )

#define FF_NAV_LAYOUT LAYOUT_frogfive_18( \
  ___, KC_PGUP, KC_UP,   KC_PGDN, KC_ESC, \
  ___, KC_LEFT, KC_DOWN, KC_RGHT, KC_ENT, \
  ___, ___,     ___,     ___,     KC_TAB, \
  /**/ /**/     _v_,     _v_,     _v_     )

#define FF_NUM_LAYOUT LAYOUT_frogfive_18( \
  FF_OFF, ___,  ___,  ___,  ___,  \
  KC_1,   KC_2, KC_3, KC_4, KC_5, \
  KC_6,   KC_7, KC_8, KC_9, KC_0, \
  /**/    /**/  _v_,  _v_,  _v_   )

#define FF_SYM_LAYOUT LAYOUT_frogfive_18( \
